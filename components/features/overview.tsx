...
export const Overview = () => {
  return (
    <motion.div
      key="overview"
      className="max-w-2xl mt-20 mx-4 md:mx-0"
    ...
    >
      <div className="border-none bg-muted/50 rounded-2xl p-6 flex flex-col gap-4 text-zinc-500 text-sm dark:text-zinc-400 dark:border-zinc-700">
        ...
        <p>
          This is an open source Chatbot template powered by the Google Gemini model built
          with Next.js and the AI SDK by Vercel. It uses the{" "}
