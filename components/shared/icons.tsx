...
export const LogoOpenAI = (props: React.SVGProps<SVGSVGElement>) => {
	return (
		<svg
			strokeLinejoin="round"
			viewBox="0 0 16 16"
...
export const LogoAnthropic = (props: React.SVGProps<SVGSVGElement>) => {
	return (
		<svg
			viewBox="0 0 92.2 65"
...
export const CheckedSquare = (props: React.SVGProps<SVGSVGElement>) => {
	return (
		<svg
			height="1em"
			strokeLinejoin="round"
...
export const UncheckedSquare = (props: React.SVGProps<SVGSVGElement>) => {
	return (
		<svg
			height="1em"
			strokeLinejoin="round"
...
export const ArrowUpRightSmallIcon = (props: React.SVGProps<SVGSVGElement>) => {
	return (
		<svg
			height="1em"
			strokeLinejoin="round"
			...
			{...props}
		>
			<title>Arrow Up Right Small</title>
			<path
				fillRule="evenodd"
				clipRule="evenodd"
...
export function HugeiconsGithub(props: React.SVGProps<SVGSVGElement>) {
	return (
		<svg
...
export function HugeiconsNewTwitter(props: React.SVGProps<SVGSVGElement>) {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			width="1em"
